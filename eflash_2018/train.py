...
import tqdm
from nuggt.utils.ngutils import red_shader, green_shader, blue_shader
...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def update_shader(self):
        if self.viewer is None:
            return
        with self.viewer.txn() as txn:
            txn.layers[self.image_names[0]].layer.shader = \
                self.shaders[0] % (self.brightness * self.multipliers[0])
